...
namespace ILRuntime.Test.Cases
{
    ...
    public class InheritanceTest
    {
        ...
        public static void InheritanceTest01()
        {
            ...
            ILRuntime.Test.ClassInheritanceTest.Test3(cls);
            ILRuntime.Test.ClassInheritanceTest.Test3(cls2);
        }
        ...
        static void Test01Sub(ILRuntime.Test.ClassInheritanceTest cls)
        {
        ...
        {
            TestCls4 cls = new TestCls4();
            cls.TestVirtual();
        }

        public static void InheritanceTest07()
        {
            ILRuntime.Test.TestClass2 cls = new TestCls5();
        ...
        {
            ILRuntime.Test.ClassInheritanceTest a = new TestCls();
            ILRuntime.Test.ClassInheritanceTest b = new TestCls2();
        ...
        public static void InheritanceTest18()
        {
            ...
            ILRuntime.Test.TestClass2.Register(obj);
        ...
        [ILRuntime.Test.ILRuntimeTest(ExpectException = typeof(InvalidCastException))]
        public static void InheritanceTest23()
        {
            ...
            if (cls2 is InterfaceTest2)
                throw new Exception();
            ILRuntime.Test.TestClass3 cls3 = (ILRuntime.Test.TestClass3)(cls as InterfaceTest2);
            if(cls3 != null)
                throw new Exception();
            cls2 = new TestCls3();
        ...
        static void Alloc<T>(out T value)where T : ILRuntime.Test.TestClass2
        {
            value = ILRuntime.Test.TestClass2.Alloc() as T;
        }

        class CrossClass : ILRuntime.Test.TestClass3
        {
        ...
        class InheritanceTest16SubCls : ILRuntime.Test.TestClass2
        {
        ...
        class InheritanceTest16SubCls2 : ILRuntime.Test.TestClass4
        {
        ...
        class TestCls5 : ILRuntime.Test.TestClass2
        {
            public int bbbb;
        ...
        class TestCls6 : ILRuntime.Test.TestClass2
        {
            public override void VMethod3(ref int arg)
            {
                base.VMethod3(ref arg);
        ...
        class TestCls7 : ILRuntime.Test.TestClass2
        {
            public override float AbMethod2(int arg1)
            {
                return arg1 + 1.2f;
        ...
        class GenericInheritanceTestCls<T> : ILRuntime.Test.ClassInheritanceTest where T : BaseData
        {
        ...
        class GenericTestCls<T>
            where T : ILRuntime.Test.ClassInheritanceTest, new()
        {
            T instance = new T();
    ...
    class TestCls : ILRuntime.Test.ClassInheritanceTest
    {
        public TestCls()
        {
            testVal = 1;
    ...
    class TestCls2 : ILRuntime.Test.ClassInheritanceTest, IAs1
    {
        public TestCls2()
            : base(4, 5)
        {
    ...
    class TestCls4 : ILRuntime.Test.ClassInheritanceTest2<TestCls4>
    {
        public override void TestVirtual()
        {
            base.TestVirtual();
    ...
    class BB : ILRuntime.Test.ClassInheritanceTest, IAs1
    {
        public void AA1()
        {
            Console.WriteLine("AA1");
    ...
    class TestAs
    {
        ...
        public static bool TestAs03()
        {
            ...
            if (ias == null)
            {
                ...
                ias.AA1();
            ILRuntime.Test.ClassInheritanceTest id = dic[0] as ILRuntime.Test.ClassInheritanceTest;
            if (id == null)
            {
    ...
    class TestIs
    {
        ...
        {
            var obj = new AA();
            ILRuntime.Test.ClassInheritanceTest.staticField = obj;
            ILRuntime.Test.ClassInheritanceTest.staticField.Dispose();
        }
    }
    ...
    {
        ILRuntime.Test.TestHashMap<TKey, TModel> map = new ILRuntime.Test.TestHashMap<TKey, TModel>();
