...
namespace ILRuntime.Test.Cases
{
    class CLRBindingTest
    {
        public static void CLRBindingTest01()
        {
            ...
            int missionID = 2;
            ILRuntime.Test.TestClass3.setBit(ref mAllMissionData[(missionID - 1) >> 2], (missionID - 1) & 3, 1);
        }

        public static void CLRBindingTest02()
        {
            int[][] val = new int[10][];
            ILRuntime.Test.StaticGenericMethods.ArrayMethod(val);
        }
        ...
        {
            ILRuntime.Test.TestCLRBinding binding = new ILRuntime.Test.TestCLRBinding();
        ...
        static void CLRBindingTest06Sub<T>(ILRuntime.Test.TestCLRBinding binding, T obj)
        {
        ...
        static void CLRBindingTest07Sub<T>(ILRuntime.Test.TestCLRBinding binding, T obj)
        {
            CLRBindingTest06Sub(binding, obj);
        }

        static void CLRBindingTest07Sub2<K, V>(K binding, V obj) where K : ILRuntime.Test.TestCLRBinding
        {
        ...
        public abstract class ISingleton<T> where T : ISingleton<T>, new()
        {
            ...
            {
                [ILRuntime.Test.ILRuntimeTest(Ignored = true)]
                get
                {
                    if (_Instance == null)
                    {
