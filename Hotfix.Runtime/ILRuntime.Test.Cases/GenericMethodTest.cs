...
namespace ILRuntime.Test.Cases
{
    ...
    class GenericMethodTest
    {
        class GTest
        {
            ...
            public T SeekUI<T>(T rootTrans, string path) where T : ILRuntime.Test.ClassInheritanceTest
            {
                return rootTrans;
            }

            public T SeekUI<T>(string path) where T : ILRuntime.Test.ClassInheritanceTest, new()
            {
                return SeekUI<T>(new T(), path);
            }

            public void SeekUI<T>(string path, out T control) where T : ILRuntime.Test.ClassInheritanceTest, new()
            {
        ...
        {
            new ILRuntime.Test.ExtensionClass().Method1(v => { });
        }

        public static void GenericExtensionMethod1Test2()
        {
            new ILRuntime.Test.ExtensionClass().Method1((i, v) => { });
        }

        public static void GenericExtensionMethod2Test1()
        {
            new ILRuntime.Test.ExtensionClass().Method2(e => { });
        }

        public static void GenericExtensionMethod2Test2()
        {
            new ILRuntime.Test.ExtensionClass().Method2((i, e) => { });
        }

        public static void GenericExtensionMethod2Test3()
        {
            new ILRuntime.Test.ExtensionClass().Method2<ArgumentException>(e => { });
        }

        public static void GenericExtensionMethod2Test4()
        {
            new ILRuntime.Test.ExtensionClass().Method2<ArgumentException>((i, e) => { });
        }

        public static void GenericExtensionMethod2Test5()
        {
            new ILRuntime.Test.ExtensionClass<int>().Method2(e => { });
        }

        public static void GenericExtensionMethod2Test6()
        {
            new ILRuntime.Test.ExtensionClass<int>().Method2((i, e) => { });
        }

        public static void GenericExtensionMethod2Test7()
        {
            new ILRuntime.Test.ExtensionClass<int>().Method2<int, ArgumentException>(e => { });
        }

        public static void GenericExtensionMethod2Test8()
        {
            new ILRuntime.Test.ExtensionClass<int>().Method2<int, ArgumentException>((i, e) => { });
        }

        public static void GenericExtensionMethod3Test1()
        {
            new ILRuntime.Test.ExtensionClass().Method3(null);
        }

        public static void GenericExtensionMethod3Test2()
        {
            new ILRuntime.Test.ExtensionClass<int>().Method3(null);
        }

        public static void GenericExtensionMethod3Test3()
        {
            new ILRuntime.Test.SubExtensionClass().Method3(null);
        }

        public static void GenericExtensionMethod3Test4()
        {
            new ILRuntime.Test.SubExtensionClass<int>().Method3(null);
        }

        public static void GenericExtensionMethod3Test5()
        {
            new ILRuntime.Test.ExtensionClass().Method3(new ArgumentException());
        }

        public static void GenericExtensionMethod3Test6()
        {
            new ILRuntime.Test.ExtensionClass<int>().Method3(new ArgumentException());
        }

        public static void GenericExtensionMethod3Test7()
        {
            new ILRuntime.Test.SubExtensionClass<int>().Method3(new ArgumentException());
        }
        ...
        {
            ILRuntime.Test.StaticGenericMethods.StaticMethod(() => { });
        }

        public static void GenericStaticMethodTest2()
        {
            ILRuntime.Test.StaticGenericMethods.StaticMethod(i => { });
        }

        public static void GenericStaticMethodTest3()
        {
            ILRuntime.Test.StaticGenericMethods.StaticMethod(() => 1);
        }

        public static void GenericStaticMethodTest4()
        {
            ILRuntime.Test.StaticGenericMethods.StaticMethod(i => 1);
        }
        
        public static void GenericStaticMethodTest5()
        {
            ILRuntime.Test.StaticGenericMethods.StaticMethod(async () => await Task.Delay(1));
        }

        public static void GenericStaticMethodTest6()
        {
            ILRuntime.Test.StaticGenericMethods.StaticMethod(async i => await Task.Delay(1));
        }

        public static void GenericStaticMethodTest7()
        {
            ILRuntime.Test.StaticGenericMethods.StaticMethod(async () => await Task.FromResult(1));
        }

        public static void GenericStaticMethodTest8()
        {
            ILRuntime.Test.StaticGenericMethods.StaticMethod(async i => await Task.FromResult(1));
        }
        ...
        {
            ILRuntime.Test.StaticGenericMethods.Method("");
        }
        ...
        {
            var e2 = GenericStaticMethodTest14Sub<ILRuntime.Test.TestVector3>();
            Console.WriteLine(e2);
        }

        public static void GenericStaticMethodTest16()
        {
            var e2 = GenericStaticMethodTest14Sub<ILRuntime.Test.TestVector3NoBinding>();
            Console.WriteLine(e2);
        }
