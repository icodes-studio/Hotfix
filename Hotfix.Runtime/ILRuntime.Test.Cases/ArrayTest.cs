...
namespace ILRuntime.Test.Cases
{
    public class ArrayTest
    {
        ...
        {
            ILRuntime.Test.TestVector3[] arr = new ILRuntime.Test.TestVector3[] { ILRuntime.Test.TestVector3.One, ILRuntime.Test.TestVector3.One2 };
        ...
        {
            ILRuntime.Test.TestClass4 cls = new ILRuntime.Test.TestClass4();
