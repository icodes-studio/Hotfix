...
namespace ILRuntime.Test.Cases
{
    class JsonTest
    {
        ...
        class MyTestDataItem : ILRuntime.Test.TestClass3
        {
            public string Type;
        }
        ...
        {
            JsonTestClass cls = new JsonTest.JsonTestClass();
            cls.IntProp = 1;
            cls.StringProp = "2";
            cls.EnumProp = JsonTestEnum.Test3;
            var sub = new JsonTest.JsonTestSubClass();
            sub.LongProp = 4;
            var sub2 = new JsonTest.JsonTestSubClass();
            sub2.LongProp = 5;
            var sub3 = new JsonTest.JsonTestSubClass();
            sub3.LongProp = 6;
            ...
            sub.SubClassList = new List<JsonTest.JsonTestSubClass>();
            ...
            cls.DicTest = new Dictionary<string, JsonTest.JsonTestSubClass>();
        ...
        class MyClass
        {
            public ILRuntime.Test.TestCLREnum myEnum;
        }
        public static void JsonTest6()
        {
            MyClass myClass = new MyClass();
            myClass.myEnum = ILRuntime.Test.TestCLREnum.Test2;

            string json = LitJson.JsonMapper.ToJson(myClass);

            MyClass myNewClass = LitJson.JsonMapper.ToObject<MyClass>(json);
            if (myNewClass.myEnum == ILRuntime.Test.TestCLREnum.Test2)
            {
