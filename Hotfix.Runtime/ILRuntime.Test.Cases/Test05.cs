...
namespace ILRuntime.Test.Cases
{
    ...
    class Test05
    {
        ...
        {
            Student<string> a = new Student<string>("aaaaaa");
        ...
        public static void TestGenericMethod()
        {
            ...
            var r = test.TestGeneric<ILRuntime.Test.TestClass3>("123", "456");
        ...
        {
            List<NRow<A, B>> res = new List<NRow<A, B>>();
            NRow<A, B> row;
            for (int i = 0; i < 1; i++)
            {
                row = new NRow<A, B>();
        ...
        [ILRuntime.Test.ILRuntimeTest(ExpectException = typeof(NotSupportedException))]
        ...
        {
            TestExplicit data = new TestExplicit(true);
            bool boolVal = (bool)data;
            Console.WriteLine("bool=" + boolVal);

            data = new TestExplicit(1.2);
