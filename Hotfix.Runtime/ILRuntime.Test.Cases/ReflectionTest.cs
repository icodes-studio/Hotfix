...
namespace ILRuntime.Test.Cases
{
    public class ReflectionTest
    {
        ...
        {
            var t = Type.GetType("ILRuntime.Test.Cases.ReflectionTest/TestCls2");
        ...
        static void ReflectionTest16Sub(ILRuntime.Test.Cases.TestCls t)
        {
        ...
        {
            var t = Type.GetType("ILRuntime.Test.Cases.ReflectionTest");
