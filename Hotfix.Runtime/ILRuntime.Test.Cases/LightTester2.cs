...
namespace ILRuntime.Test.Cases
{
    public class ExpTest_20
    {
        ...
        static ILRuntime.Test.TestVector3NoBinding ToColor(string str)
        {
            ...
            if (strNew.Length > 7)
            {
                ...
                ILRuntime.Test.TestVector3NoBinding color1 = new ILRuntime.Test.TestVector3NoBinding(num1, num3, num4);
                return color1;
            }
            ILRuntime.Test.TestVector3NoBinding color = new ILRuntime.Test.TestVector3NoBinding(num1, num2, num3);
            return color;
        }
