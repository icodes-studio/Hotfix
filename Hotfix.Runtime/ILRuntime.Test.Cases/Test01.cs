...
namespace ILRuntime.Test.Cases
{
    class Test01
    {
        ...
        public static void UnitTest_Performance2()
        {
            ...
            for (int i = 0; i < 1000000; i++)
            {
                cnt += ILRuntime.Test.TestClass2.Add(i, 2);
            }
            sw.Stop();
            Console.WriteLine(string.Format("time: {0:0}ms cps:{1:0}, result={2}", sw.ElapsedMilliseconds, (1000000 * 1000 / sw.ElapsedMilliseconds), cnt));
        }
        ...
        public static void UnitTest_Performance4()
        {
            ...
            ILRuntime.Test.DelegateTest.DelegatePerformanceTest = (a, b, c) =>
             {
                 return a + b + c;
             };
            var func2 = ILRuntime.Test.DelegateTest.DelegatePerformanceTest;
            System.Diagnostics.Stopwatch sw = new System.Diagnostics.Stopwatch();
