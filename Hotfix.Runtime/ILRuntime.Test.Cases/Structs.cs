...
namespace ILRuntime.Test.Cases
{
    ...
    public class StructTests
    {
        ...
        {
            public ILRuntime.Test.TestCLREnum value;
        }
        ...
        class TestClass
        {
            public ILRuntime.Test.TestVector3 v21 = new ILRuntime.Test.TestVector3(111, 222, 333);
            public ILRuntime.Test.TestVector3 v22 = new ILRuntime.Test.TestVector3();
        ...
        {
            ILRuntime.Test.TestVector3 vec = StructTest10Sub();
            if (vec.X != 1)
                throw new Exception();
        }

        static ILRuntime.Test.TestVector3 StructTest10Sub()
        {
            ILRuntime.Test.TestVector3 res = ILRuntime.Test.TestVector3.One2;
            switch(res.X)
            {
                case 2:
