...
namespace ILRuntime.Test.Cases
{
    public class ExpTest_10
    {
        ...
        class StructTest
        {
            ...
            public ILRuntime.Test.TestStruct Struct;
        }
        ...
        {
            StructTest a = new ExpTest_10.StructTest();
            ...
            ILRuntime.Test.TestStruct b = a.Struct;
            a.Struct.value += 100;
        ...
        {
            ILRuntime.Test.TestClass3 obj = new ILRuntime.Test.TestClass3();
            obj.Struct.value = 111;
            obj.Struct.value += 111;
            Console.WriteLine(obj.Struct.value);

            StructTest2 obj2 = new ExpTest_10.StructTest2();
            obj2.Struct.value = 111;
            obj2.Struct.value += 111;
            Console.WriteLine(obj2.Struct.value);


            ILRuntime.Test.TestStruct.instance.value = 222;
            ILRuntime.Test.TestStruct.instance.value += 111;
            Console.WriteLine(ILRuntime.Test.TestStruct.instance.value);
        }
        ...
        [ILRuntime.Test.ILRuntimeTest(ExpectException = typeof(NullReferenceException))]
