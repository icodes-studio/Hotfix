...
{
    unsafe class ILRuntime_Test_TestClass3_Binding
    {
        public static void Register(ILRuntime.Runtime.Environment.AppDomain app)
        {
            ...
            FieldInfo field;
            Type[] args;
            Type type = typeof(ILRuntime.Test.TestClass3);
        ...
        static StackObject* setBit_0(ILIntepreter __intp, StackObject* __esp, AutoList __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            ILRuntime.Test.TestClass3.setBit(ref @value, @pos, @bit);
        ...
        static StackObject* getString_1(ILIntepreter __intp, StackObject* __esp, AutoList __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            var result_of_this_method = ILRuntime.Test.TestClass3.getString(ref @startIndex, @length);
        ...
        {
            return ((ILRuntime.Test.TestClass3)o).Struct;
        }

        static StackObject* CopyToStack_Struct_0(ref object o, ILIntepreter __intp, StackObject* __ret, AutoList __mStack)
        {
            var result_of_this_method = ((ILRuntime.Test.TestClass3)o).Struct;
            return ILIntepreter.PushObject(__ret, __mStack, result_of_this_method);
        }

        static void set_Struct_0(ref object o, object v)
        {
            ((ILRuntime.Test.TestClass3)o).Struct = (ILRuntime.Test.TestStruct)v;
        }
        ...
        {
            ILRuntime.Runtime.Environment.AppDomain __domain = __intp.AppDomain;
            ILRuntime.Test.TestStruct @Struct = (ILRuntime.Test.TestStruct)typeof(ILRuntime.Test.TestStruct).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack), (CLR.Utils.Extensions.TypeFlags)16);
            ((ILRuntime.Test.TestClass3)o).Struct = @Struct;
        ...
        static StackObject* Ctor_0(ILIntepreter __intp, StackObject* __esp, AutoList __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            var result_of_this_method = new ILRuntime.Test.TestClass3();
