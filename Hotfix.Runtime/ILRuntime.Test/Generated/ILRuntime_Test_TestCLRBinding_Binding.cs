...
{
    unsafe class ILRuntime_Test_TestCLRBinding_Binding
    {
        public static void Register(ILRuntime.Runtime.Environment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(ILRuntime.Test.TestCLRBinding);
            ...
            args = new Type[]{typeof(ILRuntime.Test.TestCLRBinding)};
            if (genericMethods.TryGetValue("Emit", out lst))
            {
                foreach(var m in lst)
                {
                    if(m.MatchGenericParameters(args, typeof(void), typeof(ILRuntime.Test.TestCLRBinding)))
                    {
            ...
            if (genericMethods.TryGetValue("LoadAsset", out lst))
            {
                foreach(var m in lst)
                {
                    if(m.MatchGenericParameters(args, typeof(void), typeof(System.String), typeof(ILRuntime.Test.TestCLRBinding)))
                    {
                        method = m.MakeGenericMethod(args);
        ...
        static StackObject* Emit_0(ILIntepreter __intp, StackObject* __esp, AutoList __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            ILRuntime.Test.TestCLRBinding @obj = (ILRuntime.Test.TestCLRBinding)typeof(ILRuntime.Test.TestCLRBinding).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack), (CLR.Utils.Extensions.TypeFlags)0);
            __intp.Free(ptr_of_this_method);

            ptr_of_this_method = ILIntepreter.Minus(__esp, 2);
            ILRuntime.Test.TestCLRBinding instance_of_this_method = (ILRuntime.Test.TestCLRBinding)typeof(ILRuntime.Test.TestCLRBinding).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack), (CLR.Utils.Extensions.TypeFlags)0);
            __intp.Free(ptr_of_this_method);

            instance_of_this_method.Emit<ILRuntime.Test.TestCLRBinding>(@obj);
        ...
        static StackObject* LoadAsset_1(ILIntepreter __intp, StackObject* __esp, AutoList __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            instance_of_this_method.LoadAsset<ILRuntime.Test.TestCLRBinding>(@name, @obj);
        ...
        static StackObject* Ctor_0(ILIntepreter __intp, StackObject* __esp, AutoList __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            var result_of_this_method = new ILRuntime.Test.TestCLRBinding();
