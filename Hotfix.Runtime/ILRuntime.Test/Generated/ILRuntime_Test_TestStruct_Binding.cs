...
{
    unsafe class ILRuntime_Test_TestStruct_Binding
    {
        public static void Register(ILRuntime.Runtime.Environment.AppDomain app)
        {
            ...
            FieldInfo field;
            Type[] args;
            Type type = typeof(ILRuntime.Test.TestStruct);
            args = new Type[]{typeof(ILRuntime.Test.TestStruct).MakeByRefType()};
            ...
            args = new Type[]{typeof(ILRuntime.Test.TestStruct)};
            ...
            app.RegisterCLRCreateDefaultInstance(type, () => new ILRuntime.Test.TestStruct());


        }

        static void WriteBackInstance(ILRuntime.Runtime.Environment.AppDomain __domain, StackObject* ptr_of_this_method, AutoList __mStack, ref ILRuntime.Test.TestStruct instance_of_this_method)
        {
            ...
            switch(ptr_of_this_method->ObjectType)
            {
                ...
                case ObjectTypes.StaticFieldReference:
                 ...
                 case ObjectTypes.ArrayReference:
                    {
                        var instance_of_arrayReference = __mStack[ptr_of_this_method->Value] as ILRuntime.Test.TestStruct[];
        ...
        static StackObject* DoTest_0(ILIntepreter __intp, StackObject* __esp, AutoList __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            ILRuntime.Test.TestStruct @a = (ILRuntime.Test.TestStruct)typeof(ILRuntime.Test.TestStruct).CheckCLRTypes(__intp.RetriveObject(ptr_of_this_method, __mStack), (CLR.Utils.Extensions.TypeFlags)16);


            ILRuntime.Test.TestStruct.DoTest(ref @a);
        ...
        static StackObject* DoTest2_2(ILIntepreter __intp, StackObject* __esp, AutoList __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            ptr_of_this_method = ILIntepreter.Minus(__esp, 1);
            ILRuntime.Test.TestStruct @aaa = (ILRuntime.Test.TestStruct)typeof(ILRuntime.Test.TestStruct).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack), (CLR.Utils.Extensions.TypeFlags)16);
            __intp.Free(ptr_of_this_method);


            ILRuntime.Test.TestStruct.DoTest2(@aaa);
        ...
        {
            ILRuntime.Test.TestStruct ins =(ILRuntime.Test.TestStruct)o;
        ...
        {
            ILRuntime.Runtime.Environment.AppDomain __domain = __intp.AppDomain;
            ILRuntime.Test.TestStruct @instance = (ILRuntime.Test.TestStruct)typeof(ILRuntime.Test.TestStruct).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack), (CLR.Utils.Extensions.TypeFlags)16);
            ILRuntime.Test.TestStruct.instance = @instance;
            return ptr_of_this_method;
        }
        ...
        {
            var ins = new ILRuntime.Test.TestStruct();
            ins = (ILRuntime.Test.TestStruct)o;
            return ins;
        }
