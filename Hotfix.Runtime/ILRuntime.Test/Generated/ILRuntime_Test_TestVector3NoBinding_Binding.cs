...
{
    unsafe class ILRuntime_Test_TestVector3NoBinding_Binding
    {
        public static void Register(ILRuntime.Runtime.Environment.AppDomain app)
        {
            ...
            FieldInfo field;
            Type[] args;
            Type type = typeof(ILRuntime.Test.TestVector3NoBinding);
            args = new Type[]{};
            method = type.GetMethod("get_one", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, get_one_0);
            args = new Type[]{typeof(ILRuntime.Test.TestVector3NoBinding), typeof(System.Single)};
            method = type.GetMethod("op_Multiply", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, op_Multiply_1);
            args = new Type[]{typeof(ILRuntime.Test.TestVector3NoBinding), typeof(ILRuntime.Test.TestVector3NoBinding)};
            ...
            app.RegisterCLRCreateDefaultInstance(type, () => new ILRuntime.Test.TestVector3NoBinding());
        ...
        static void WriteBackInstance(ILRuntime.Runtime.Environment.AppDomain __domain, StackObject* ptr_of_this_method, AutoList __mStack, ref ILRuntime.Test.TestVector3NoBinding instance_of_this_method)
        {
            ...
            switch(ptr_of_this_method->ObjectType)
            {
                ...
                case ObjectTypes.StaticFieldReference:
                 ...
                 case ObjectTypes.ArrayReference:
                    {
                        var instance_of_arrayReference = __mStack[ptr_of_this_method->Value] as ILRuntime.Test.TestVector3NoBinding[];
        ...
        static StackObject* get_one_0(ILIntepreter __intp, StackObject* __esp, AutoList __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            var result_of_this_method = ILRuntime.Test.TestVector3NoBinding.one;
        ...
        static StackObject* op_Multiply_1(ILIntepreter __intp, StackObject* __esp, AutoList __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            ILRuntime.Test.TestVector3NoBinding @a = (ILRuntime.Test.TestVector3NoBinding)typeof(ILRuntime.Test.TestVector3NoBinding).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack), (CLR.Utils.Extensions.TypeFlags)16);
        ...
        static StackObject* op_Addition_2(ILIntepreter __intp, StackObject* __esp, AutoList __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            ptr_of_this_method = ILIntepreter.Minus(__esp, 1);
            ILRuntime.Test.TestVector3NoBinding @b = (ILRuntime.Test.TestVector3NoBinding)typeof(ILRuntime.Test.TestVector3NoBinding).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack), (CLR.Utils.Extensions.TypeFlags)16);
            __intp.Free(ptr_of_this_method);
        ...
        static StackObject* get_zero_3(ILIntepreter __intp, StackObject* __esp, AutoList __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            var result_of_this_method = ILRuntime.Test.TestVector3NoBinding.zero;
        ...
        {
            return ((ILRuntime.Test.TestVector3NoBinding)o).x;
        }

        static StackObject* CopyToStack_x_0(ref object o, ILIntepreter __intp, StackObject* __ret, AutoList __mStack)
        {
            var result_of_this_method = ((ILRuntime.Test.TestVector3NoBinding)o).x;
        ...
        {
            ILRuntime.Test.TestVector3NoBinding ins =(ILRuntime.Test.TestVector3NoBinding)o;
        ...
        {
            return ((ILRuntime.Test.TestVector3NoBinding)o).y;
        }

        static StackObject* CopyToStack_y_1(ref object o, ILIntepreter __intp, StackObject* __ret, AutoList __mStack)
        {
            var result_of_this_method = ((ILRuntime.Test.TestVector3NoBinding)o).y;
            __ret->ObjectType = ObjectTypes.Float;
            *(float*)&__ret->Value = result_of_this_method;
            return __ret + 1;
        }
        ...
        {
            return ((ILRuntime.Test.TestVector3NoBinding)o).z;
        }

        static StackObject* CopyToStack_z_2(ref object o, ILIntepreter __intp, StackObject* __ret, AutoList __mStack)
        {
            var result_of_this_method = ((ILRuntime.Test.TestVector3NoBinding)o).z;
            __ret->ObjectType = ObjectTypes.Float;
            *(float*)&__ret->Value = result_of_this_method;
            return __ret + 1;
        }
        ...
        {
            var ins = new ILRuntime.Test.TestVector3NoBinding();
            ins = (ILRuntime.Test.TestVector3NoBinding)o;
            return ins;
        }
        ...
        static StackObject* Ctor_0(ILIntepreter __intp, StackObject* __esp, AutoList __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            var result_of_this_method = new ILRuntime.Test.TestVector3NoBinding(@x, @y, @z);
