...
{
    unsafe class ILRuntime_Runtime_Environment_AppDomain_Binding
    {
        public static void Register(ILRuntime.Runtime.Environment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(ILRuntime.Runtime.Environment.AppDomain);
        ...
        static StackObject* set_AllowUnboundCLRMethod_0(ILIntepreter __intp, StackObject* __esp, AutoList __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            ILRuntime.Runtime.Environment.AppDomain instance_of_this_method = (ILRuntime.Runtime.Environment.AppDomain)typeof(ILRuntime.Runtime.Environment.AppDomain).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack), (CLR.Utils.Extensions.TypeFlags)0);
