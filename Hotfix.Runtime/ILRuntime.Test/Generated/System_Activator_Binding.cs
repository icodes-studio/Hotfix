    ...
    unsafe class System_Activator_Binding
    {
        public static void Register(ILRuntime.Runtime.Environment.AppDomain app)
        {
            ...
            if (genericMethods.TryGetValue("CreateInstance", out lst))
            {
                foreach(var m in lst)
                {
                    if(m.MatchGenericParameters(args, typeof(ILRuntime.Test.ClassInheritanceTestAdaptor.Adaptor)))
                    {
                        method = m.MakeGenericMethod(args);
            ...
            if (genericMethods.TryGetValue("CreateInstance", out lst))
            {
                foreach(var m in lst)
                {
                    if(m.MatchGenericParameters(args, typeof(ILRuntime.Test.TestVector3)))
                    {
                        method = m.MakeGenericMethod(args);
        ...
        static StackObject* CreateInstance_3(ILIntepreter __intp, StackObject* __esp, AutoList __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            var result_of_this_method = System.Activator.CreateInstance<ILRuntime.Test.ClassInheritanceTestAdaptor.Adaptor>();
        ...
        static StackObject* CreateInstance_4(ILIntepreter __intp, StackObject* __esp, AutoList __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            var result_of_this_method = System.Activator.CreateInstance<ILRuntime.Test.TestVector3>();
