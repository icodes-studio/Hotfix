...
{
    unsafe class System_Threading_Tasks_Task_1_Int32_Binding
    {
        public static void Register(ILRuntime.Runtime.Environment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(System.Threading.Tasks.Task<System.Int32>);
            args = new Type[]{};
        ...
        static StackObject* GetAwaiter_0(ILIntepreter __intp, StackObject* __esp, AutoList __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            System.Threading.Tasks.Task<System.Int32> instance_of_this_method = (System.Threading.Tasks.Task<System.Int32>)typeof(System.Threading.Tasks.Task<System.Int32>).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack), (CLR.Utils.Extensions.TypeFlags)0);
