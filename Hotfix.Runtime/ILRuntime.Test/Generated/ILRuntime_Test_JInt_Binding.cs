...
{
    unsafe class ILRuntime_Test_JInt_Binding
    {
        public static void Register(ILRuntime.Runtime.Environment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(ILRuntime.Test.JInt);
            MethodInfo[] methods = type.GetMethods(flag).Where(t => !t.IsGenericMethod).ToArray();
            args = new Type[]{typeof(ILRuntime.Test.JInt)};
            method = type.GetMethod("op_Increment", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, op_Increment_0);
            args = new Type[]{typeof(System.Int32)};
            method = methods.Where(t => t.Name.Equals("op_Implicit") && t.ReturnType == typeof(ILRuntime.Test.JInt) && t.CheckMethodParams(args)).Single();
            app.RegisterCLRMethodRedirection(method, op_Implicit_1);
            args = new Type[]{typeof(ILRuntime.Test.JInt), typeof(ILRuntime.Test.JInt)};
            ...
            args = new Type[]{typeof(ILRuntime.Test.JInt), typeof(System.Int32)};
            ...
            app.RegisterCLRCreateDefaultInstance(type, () => new ILRuntime.Test.JInt());


        }

        static void WriteBackInstance(ILRuntime.Runtime.Environment.AppDomain __domain, StackObject* ptr_of_this_method, AutoList __mStack, ref ILRuntime.Test.JInt instance_of_this_method)
        {
            ...
            switch(ptr_of_this_method->ObjectType)
            {
                ...
                case ObjectTypes.StaticFieldReference:
                 ...
                 case ObjectTypes.ArrayReference:
                    {
                        var instance_of_arrayReference = __mStack[ptr_of_this_method->Value] as ILRuntime.Test.JInt[];
        ...
        static StackObject* op_Increment_0(ILIntepreter __intp, StackObject* __esp, AutoList __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            ILRuntime.Test.JInt @a = (ILRuntime.Test.JInt)typeof(ILRuntime.Test.JInt).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack), (CLR.Utils.Extensions.TypeFlags)16);
        ...
        static StackObject* op_Implicit_1(ILIntepreter __intp, StackObject* __esp, AutoList __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            var result_of_this_method = (ILRuntime.Test.JInt)val;
        ...
        static StackObject* op_Inequality_2(ILIntepreter __intp, StackObject* __esp, AutoList __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            ptr_of_this_method = ILIntepreter.Minus(__esp, 1);
            ILRuntime.Test.JInt @b = (ILRuntime.Test.JInt)typeof(ILRuntime.Test.JInt).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack), (CLR.Utils.Extensions.TypeFlags)16);
            __intp.Free(ptr_of_this_method);
        ...
        static StackObject* op_Implicit_5(ILIntepreter __intp, StackObject* __esp, AutoList __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            ptr_of_this_method = ILIntepreter.Minus(__esp, 1);
            ILRuntime.Test.JInt @val = (ILRuntime.Test.JInt)typeof(ILRuntime.Test.JInt).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack), (CLR.Utils.Extensions.TypeFlags)16);
            __intp.Free(ptr_of_this_method);
