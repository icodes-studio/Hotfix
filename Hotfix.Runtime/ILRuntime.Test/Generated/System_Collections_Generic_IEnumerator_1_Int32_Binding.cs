...
{
    unsafe class System_Collections_Generic_IEnumerator_1_Int32_Binding
    {
        public static void Register(ILRuntime.Runtime.Environment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(System.Collections.Generic.IEnumerator<System.Int32>);
            args = new Type[]{};
        ...
        static StackObject* get_Current_0(ILIntepreter __intp, StackObject* __esp, AutoList __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            System.Collections.Generic.IEnumerator<System.Int32> instance_of_this_method = (System.Collections.Generic.IEnumerator<System.Int32>)typeof(System.Collections.Generic.IEnumerator<System.Int32>).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack), (CLR.Utils.Extensions.TypeFlags)0);
