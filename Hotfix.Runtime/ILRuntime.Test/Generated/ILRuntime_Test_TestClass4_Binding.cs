...
{
    unsafe class ILRuntime_Test_TestClass4_Binding
    {
        public static void Register(ILRuntime.Runtime.Environment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(ILRuntime.Test.TestClass4);
        ...
        static StackObject* TestArrayOut_0(ILIntepreter __intp, StackObject* __esp, AutoList __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            ILRuntime.Test.TestStruct[] @arr = (ILRuntime.Test.TestStruct[])typeof(ILRuntime.Test.TestStruct[]).CheckCLRTypes(__intp.RetriveObject(ptr_of_this_method, __mStack), (CLR.Utils.Extensions.TypeFlags)0);

            ptr_of_this_method = ILIntepreter.Minus(__esp, 2);
            ILRuntime.Test.TestClass4 instance_of_this_method = (ILRuntime.Test.TestClass4)typeof(ILRuntime.Test.TestClass4).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack), (CLR.Utils.Extensions.TypeFlags)0);
        ...
        static StackObject* Ctor_0(ILIntepreter __intp, StackObject* __esp, AutoList __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            var result_of_this_method = new ILRuntime.Test.TestClass4();
