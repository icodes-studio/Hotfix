...
namespace ILRuntime.Runtime.Generated
{
    unsafe class LitJson_JsonMapper_Binding
    {
        public static void Register(ILRuntime.Runtime.Environment.AppDomain app)
        {
            ...
            args = new Type[]{typeof(System.Collections.Generic.List<ILRuntime.Test.TestClass3Adaptor.Adaptor>)};
            if (genericMethods.TryGetValue("ToObject", out lst))
            {
                foreach(var m in lst)
                {
                    if(m.MatchGenericParameters(args, typeof(System.Collections.Generic.List<ILRuntime.Test.TestClass3Adaptor.Adaptor>), typeof(System.String)))
                    {
                        method = m.MakeGenericMethod(args);
        ...
        static StackObject* ToJson_1(ILIntepreter __intp, StackObject* __esp, AutoList __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Environment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
            StackObject* __ret = ILIntepreter.Minus(__esp, 1);
        ...
        static StackObject* ToObject_2(ILIntepreter __intp, StackObject* __esp, AutoList __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            var result_of_this_method = LitJson.JsonMapper.ToObject<System.Collections.Generic.List<ILRuntime.Test.TestClass3Adaptor.Adaptor>>(@json);
