...
{
    unsafe class ILRuntime_Test_TestHashMap_2_String_ILTypeInstance_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(ILRuntime.Test.TestHashMap<System.String, ILRuntime.Runtime.Intepreter.ILTypeInstance>);
        ...
        static StackObject* Add_0(ILIntepreter __intp, StackObject* __esp, AutoList __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            ILRuntime.Test.TestHashMap<System.String, ILRuntime.Runtime.Intepreter.ILTypeInstance> instance_of_this_method = (ILRuntime.Test.TestHashMap<System.String, ILRuntime.Runtime.Intepreter.ILTypeInstance>)typeof(ILRuntime.Test.TestHashMap<System.String, ILRuntime.Runtime.Intepreter.ILTypeInstance>).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack), (CLR.Utils.Extensions.TypeFlags)0);
            __intp.Free(ptr_of_this_method);

            var result_of_this_method = instance_of_this_method.Add(@key, @value);
        ...
        static StackObject* Ctor_0(ILIntepreter __intp, StackObject* __esp, AutoList __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            var result_of_this_method = new ILRuntime.Test.TestHashMap<System.String, ILRuntime.Runtime.Intepreter.ILTypeInstance>();
