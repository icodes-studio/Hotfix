...
namespace ILRuntime.Runtime.Generated
{
    unsafe class ILRuntime_Test_TestStructB_Binding
    {
        ...
        static void WriteBackInstance(ILRuntime.Runtime.Enviorment.AppDomain __domain, StackObject* ptr_of_this_method, AutoList __mStack, ref ILRuntime.Test.TestStructB instance_of_this_method)
        {
