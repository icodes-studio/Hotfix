...
{
    unsafe class ILRuntime_Test_TestCLREnumClass_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            FieldInfo field;
            Type[] args;
            Type type = typeof(ILRuntime.Test.TestCLREnumClass);
            args = new Type[]{typeof(System.UInt32).MakeByRefType(), typeof(ILRuntime.Test.TestCLREnum).MakeByRefType()};
        ...
        static StackObject* TestCLREnumRef_0(ILIntepreter __intp, StackObject* __esp, AutoList __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            ILRuntime.Test.TestCLREnum @tag = (ILRuntime.Test.TestCLREnum)__intp.RetriveInt32(ptr_of_this_method, __mStack);

            ptr_of_this_method = ILIntepreter.Minus(__esp, 2);
            System.UInt32 @key = (System.UInt32)__intp.RetriveInt32(ptr_of_this_method, __mStack);


            ILRuntime.Test.TestCLREnumClass.TestCLREnumRef(out @key, out @tag);
            ...
            switch(ptr_of_this_method->ObjectType)
            {
                ...
                case ObjectTypes.StaticFieldReference:
                 ...
                 case ObjectTypes.ArrayReference:
                    {
                        var instance_of_arrayReference = __mStack[ptr_of_this_method->Value] as ILRuntime.Test.TestCLREnum[];
        ...
        static StackObject* get_Test2_1(ILIntepreter __intp, StackObject* __esp, AutoList __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            var result_of_this_method = ILRuntime.Test.TestCLREnumClass.Test2;
        ...
        {
            return ILRuntime.Test.TestCLREnumClass.Test;
        }

        static StackObject* CopyToStack_Test_0(ref object o, ILIntepreter __intp, StackObject* __ret, AutoList __mStack)
        {
            var result_of_this_method = ILRuntime.Test.TestCLREnumClass.Test;
            return ILIntepreter.PushObject(__ret, __mStack, result_of_this_method);
        }

        static void set_Test_0(ref object o, object v)
        {
            ILRuntime.Test.TestCLREnumClass.Test = (ILRuntime.Test.TestCLREnum)v;
        }
        ...
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            ILRuntime.Test.TestCLREnum @Test = (ILRuntime.Test.TestCLREnum)typeof(ILRuntime.Test.TestCLREnum).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack), (CLR.Utils.Extensions.TypeFlags)20);
            ILRuntime.Test.TestCLREnumClass.Test = @Test;
