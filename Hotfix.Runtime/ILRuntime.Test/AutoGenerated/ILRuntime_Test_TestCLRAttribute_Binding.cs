...
{
    unsafe class ILRuntime_Test_TestCLRAttribute_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            FieldInfo field;
            Type[] args;
            Type type = typeof(ILRuntime.Test.TestCLRAttribute);
        ...
        {
            return ((ILRuntime.Test.TestCLRAttribute)o).Name;
        }

        static StackObject* CopyToStack_Name_0(ref object o, ILIntepreter __intp, StackObject* __ret, AutoList __mStack)
        {
            var result_of_this_method = ((ILRuntime.Test.TestCLRAttribute)o).Name;
            return ILIntepreter.PushObject(__ret, __mStack, result_of_this_method);
        }

        static void set_Name_0(ref object o, object v)
        {
            ((ILRuntime.Test.TestCLRAttribute)o).Name = (System.String)v;
        }
        ...
        static StackObject* AssignFromStack_Name_0(ref object o, ILIntepreter __intp, StackObject* ptr_of_this_method, AutoList __mStack)
        {
            ...
            ((ILRuntime.Test.TestCLRAttribute)o).Name = @Name;
