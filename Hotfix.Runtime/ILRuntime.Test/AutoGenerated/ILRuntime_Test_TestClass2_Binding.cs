...
{
    unsafe class ILRuntime_Test_TestClass2_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(ILRuntime.Test.TestClass2);
            args = new Type[]{};
            ...
            args = new Type[]{typeof(ILRuntime.Test.TestClass2)};
        ...
        static StackObject* VMethod1_0(ILIntepreter __intp, StackObject* __esp, AutoList __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            ILRuntime.Test.TestClass2 instance_of_this_method = (ILRuntime.Test.TestClass2)typeof(ILRuntime.Test.TestClass2).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack), (CLR.Utils.Extensions.TypeFlags)0);
        ...
        static StackObject* Register_3(ILIntepreter __intp, StackObject* __esp, AutoList __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            ptr_of_this_method = ILIntepreter.Minus(__esp, 1);
            ILRuntime.Test.TestClass2 @obj = (ILRuntime.Test.TestClass2)typeof(ILRuntime.Test.TestClass2).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack), (CLR.Utils.Extensions.TypeFlags)0);
            __intp.Free(ptr_of_this_method);
        ...
        static StackObject* Alloc_4(ILIntepreter __intp, StackObject* __esp, AutoList __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            var result_of_this_method = ILRuntime.Test.TestClass2.Alloc();
        ...
        static StackObject* Add_6(ILIntepreter __intp, StackObject* __esp, AutoList __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            var result_of_this_method = ILRuntime.Test.TestClass2.Add(@a, @b);
