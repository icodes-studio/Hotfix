...
namespace ILRuntime.Runtime.Generated
{
    unsafe class System_Func_1_TestVector3_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(System.Func<ILRuntime.Test.TestVector3>);
            args = new Type[]{};
        ...
        static StackObject* Invoke_0(ILIntepreter __intp, StackObject* __esp, AutoList __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            System.Func<ILRuntime.Test.TestVector3> instance_of_this_method = (System.Func<ILRuntime.Test.TestVector3>)typeof(System.Func<ILRuntime.Test.TestVector3>).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack), (CLR.Utils.Extensions.TypeFlags)8);
