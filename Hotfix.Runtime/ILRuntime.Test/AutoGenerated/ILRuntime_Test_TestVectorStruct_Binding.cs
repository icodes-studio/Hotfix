...
namespace ILRuntime.Runtime.Generated
{
    unsafe class ILRuntime_Test_TestVectorStruct_Binding
    {
        ...
        static void WriteBackInstance(ILRuntime.Runtime.Enviorment.AppDomain __domain, StackObject* ptr_of_this_method, AutoList __mStack, ref ILRuntime.Test.TestVectorStruct instance_of_this_method)
        {
