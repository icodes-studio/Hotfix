...
{
    unsafe class ILRuntime_Test_StaticGenericMethods_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(ILRuntime.Test.StaticGenericMethods);
            ...
            args = new Type[]{typeof(System.Action<ILRuntime.Test.ExtensionClass>)};
            method = type.GetMethod("StaticMethod", flag, null, args, null);
            ...
            if (genericMethods.TryGetValue("StaticMethod", out lst))
            {
                foreach(var m in lst)
                {
                    if(m.MatchGenericParameters(args, typeof(void), typeof(System.Func<ILRuntime.Test.ExtensionClass, System.Int32>)))
                    {
                        method = m.MakeGenericMethod(args);
            ...
            args = new Type[]{typeof(System.Func<ILRuntime.Test.ExtensionClass, System.Threading.Tasks.Task>)};
            method = type.GetMethod("StaticMethod", flag, null, args, null);
            ...
            if (genericMethods.TryGetValue("StaticMethod", out lst))
            {
                foreach(var m in lst)
                {
                    if(m.MatchGenericParameters(args, typeof(void), typeof(System.Func<ILRuntime.Test.ExtensionClass, System.Threading.Tasks.Task<System.Int32>>)))
                    {
                        method = m.MakeGenericMethod(args);
        ...
        static StackObject* ArrayMethod_0(ILIntepreter __intp, StackObject* __esp, AutoList __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            ILRuntime.Test.StaticGenericMethods.ArrayMethod<System.Int32>(@val);
        ...
        static StackObject* StaticMethod_2(ILIntepreter __intp, StackObject* __esp, AutoList __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            ILRuntime.Test.StaticGenericMethods.StaticMethod(@action);
        ...
        static StackObject* StaticMethod_3(ILIntepreter __intp, StackObject* __esp, AutoList __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            ptr_of_this_method = ILIntepreter.Minus(__esp, 1);
            System.Action<ILRuntime.Test.ExtensionClass> @action = (System.Action<ILRuntime.Test.ExtensionClass>)typeof(System.Action<ILRuntime.Test.ExtensionClass>).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack), (CLR.Utils.Extensions.TypeFlags)8);
            __intp.Free(ptr_of_this_method);
        ...
        static StackObject* StaticMethod_4(ILIntepreter __intp, StackObject* __esp, AutoList __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            ILRuntime.Test.StaticGenericMethods.StaticMethod<System.Int32>(@func);
        ...
        static StackObject* StaticMethod_5(ILIntepreter __intp, StackObject* __esp, AutoList __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            ptr_of_this_method = ILIntepreter.Minus(__esp, 1);
            System.Func<ILRuntime.Test.ExtensionClass, System.Int32> @action = (System.Func<ILRuntime.Test.ExtensionClass, System.Int32>)typeof(System.Func<ILRuntime.Test.ExtensionClass, System.Int32>).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack), (CLR.Utils.Extensions.TypeFlags)8);
            __intp.Free(ptr_of_this_method);


            ILRuntime.Test.StaticGenericMethods.StaticMethod<System.Int32>(@action);
        ...
        static StackObject* StaticMethod_6(ILIntepreter __intp, StackObject* __esp, AutoList __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            ILRuntime.Test.StaticGenericMethods.StaticMethod(@func);
        ...
        static StackObject* StaticMethod_7(ILIntepreter __intp, StackObject* __esp, AutoList __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            ptr_of_this_method = ILIntepreter.Minus(__esp, 1);
            System.Func<ILRuntime.Test.ExtensionClass, System.Threading.Tasks.Task> @func = (System.Func<ILRuntime.Test.ExtensionClass, System.Threading.Tasks.Task>)typeof(System.Func<ILRuntime.Test.ExtensionClass, System.Threading.Tasks.Task>).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack), (CLR.Utils.Extensions.TypeFlags)8);
            __intp.Free(ptr_of_this_method);
        ...
        static StackObject* StaticMethod_9(ILIntepreter __intp, StackObject* __esp, AutoList __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            ptr_of_this_method = ILIntepreter.Minus(__esp, 1);
            System.Func<ILRuntime.Test.ExtensionClass, System.Threading.Tasks.Task<System.Int32>> @func = (System.Func<ILRuntime.Test.ExtensionClass, System.Threading.Tasks.Task<System.Int32>>)typeof(System.Func<ILRuntime.Test.ExtensionClass, System.Threading.Tasks.Task<System.Int32>>).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack), (CLR.Utils.Extensions.TypeFlags)8);
            __intp.Free(ptr_of_this_method);
        ...
        static StackObject* Method_10(ILIntepreter __intp, StackObject* __esp, AutoList __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            ILRuntime.Test.StaticGenericMethods.Method(@name, @panels);
