...
{
    unsafe class Hotfix_Unity_DelegateFunction_Binding
    {
        public static void Register(ILRuntime.Runtime.Environment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(Hotfix.Unity.DelegateFunction);
        ...
        static StackObject* Invoke_0(ILIntepreter __intp, StackObject* __esp, AutoList __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            Hotfix.Unity.DelegateFunction instance_of_this_method = (Hotfix.Unity.DelegateFunction)typeof(Hotfix.Unity.DelegateFunction).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack), (CLR.Utils.Extensions.TypeFlags)8);
