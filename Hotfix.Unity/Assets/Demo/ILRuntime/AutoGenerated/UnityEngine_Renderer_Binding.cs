...
namespace ILRuntime.Runtime.Generated
{
    unsafe class UnityEngine_Renderer_Binding
    {
        public static void Register(ILRuntime.Runtime.Environment.AppDomain app)
        {
            ...
            app.RegisterCLRMethodRedirection(method, set_receiveShadows_0);


        }


        static StackObject* set_receiveShadows_0(ILIntepreter __intp, StackObject* __esp, AutoList __mStack, CLRMethod __method, bool isNewObj)
        {
