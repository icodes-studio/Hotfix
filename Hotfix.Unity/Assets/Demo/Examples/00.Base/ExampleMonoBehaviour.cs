...
namespace Hotfix.Demo
{
    ...
    {
        // AppDomain is the entrance to ILRuntime. It is best to save it in a singleton class.
        ...
        protected IEnumerator Start()
        {
            ...
            // In normal projects, you should download the dll from other places and read it in AssetBundle.
            // For demonstration convenience, you should read it directly from StreamingAssets.
            ...
            // The Hotfix project file is \Hotfix\Hotfix\Hotfix.csproj
#if UNITY_ANDROID
            ...
            // However, it will consume additional memory, please remove the PDB when it is officially released.
            // Just pass null to pdb when LoadAssembly is called.
#if UNITY_ANDROID
